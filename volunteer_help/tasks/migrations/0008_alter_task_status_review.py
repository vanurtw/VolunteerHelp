# Generated by Django 6.0.4 on 2026-06-05 18:34
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('tasks', '0007_task_volunteer_alter_responsetask_volunteer'),
    ...
    operations = [
        migrations.AlterField(
            model_name='task',
            name='status',
            field=models.CharField(choices=[('open', 'открыта'), ('in_progress', 'в работе'), ('completed', 'выполнена'), ('canceled', 'отменена'), ('pending_confirmation', 'Ожидает подтверждения')], default='open', max_length=20),
        ),
